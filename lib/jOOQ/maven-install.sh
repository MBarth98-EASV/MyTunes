...
mvn install:install-file -Dfile=jOOQ-lib/jooq-meta-extensions-hibernate-$VERSION.jar -DgroupId=org.jooq -DartifactId=jooq-meta-extensions-hibernate -Dversion=$VERSION -Dpackaging=jar $JAVADOC_JOOQ_META_EXTENSIONS_HIBERNATE $SOURCES_JOOQ_META_EXTENSIONS_HIBERNATE -DpomFile=jOOQ-pom/jooq-meta-extensions-hibernate/pom.xml
mvn install:install-file -Dfile=jOOQ-lib/jooq-meta-extensions-liquibase-$VERSION.jar -DgroupId=org.jooq -DartifactId=jooq-meta-extensions-liquibase -Dversion=$VERSION -Dpackaging=jar $JAVADOC_JOOQ_META_EXTENSIONS_LIQUIBASE $SOURCES_JOOQ_META_EXTENSIONS_LIQUIBASE -DpomFile=jOOQ-pom/jooq-meta-extensions-liquibase/pom.xml
...
mvn install:install-file -Dfile=jOOQ-lib/jooq-scala_2.13-$VERSION.jar                -DgroupId=org.jooq -DartifactId=jooq-scala_2.13                -Dversion=$VERSION -Dpackaging=jar $JAVADOC_JOOQ_SCALA_2_13                $SOURCES_JOOQ_SCALA_2_13                -DpomFile=jOOQ-pom/jooq-scala_2.13/pom.xml
mvn install:install-file -Dfile=jOOQ-lib/jooq-kotlin-$VERSION.jar                    -DgroupId=org.jooq -DartifactId=jooq-kotlin                    -Dversion=$VERSION -Dpackaging=jar $JAVADOC_JOOQ_KOTLIN                    $SOURCES_JOOQ_KOTLIN                    -DpomFile=jOOQ-pom/jooq-kotlin/pom.xml
mvn install:install-file -Dfile=jOOQ-lib/jooq-xtend-$VERSION.jar                     -DgroupId=org.jooq -DartifactId=jooq-xtend                     -Dversion=$VERSION -Dpackaging=jar $JAVADOC_JOOQ_XTEND                     $SOURCES_JOOQ_XTEND                     -DpomFile=jOOQ-pom/jooq-xtend/pom.xml
